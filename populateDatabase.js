...
function authorCreate(firstName, familyName, dateOfBirth, dateOfDeath, cb) {
  let authorDetail = { firstName, familyName }
  if (dateOfBirth) authorDetail.dateOfBirth = dateOfBirth;
  if (dateOfDeath) authorDetail.dateOfDeath = dateOfDeath;
...
function bookCreate(title, summary, isbn, author, genre, cb) {
  let bookDetail = { title, summary, author, isbn }
...
function bookInstanceCreate(book, imprint, due, status, cb) {
  let bookInstanceDetail = { book, imprint }
  if (due) bookInstanceDetail.due = due
